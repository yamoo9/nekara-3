...
export const GlobalStyle = createGlobalStyle`
  ...
  .upgradeBrowserInfo {
    ...
    align-items: center;
    background: 
      linear-gradient(to bottom, var(--transparent-black), var(--transparent-black)),
      url("https://images.pexels.com/photos/4091/woman-dropped-fail-failure.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260") center / cover;
    line-height: 1.75;
    text-align: center;
  }
